...
//#define START_FREQUENCY1 14484 //microcantilever specific resonant frequency minus half of the number of increments
//#define START_FREQUENCY2 16830 //microcantilever specific resonant frequency minus half of the number of increments
//#define START_FREQUENCY3 15560 //microcantilever specific resonant frequency minus half of the number of increments

#define NUM_INCREMENTS  501
#define STEP_SIZE 1 //increment frequency (1)
#define SETTLING_CYCLES 20 // Define the settling cycles (adjust as needed)
...
void sendDataToRaspberryPi(float phaseData[3][NUM_INCREMENTS], float temperature, float humidity);
